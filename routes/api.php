...
// Banks (formerly nested under divisi)
Route::apiResource('banks', BankController::class)
    ->parameters(['banks' => 'noRekening']);
...
Route::get('saldo-banks/bank/{noRekening}', [SaldoBankController::class, 'getByBank']);
Route::get('saldo-banks/bank/{noRekening}/latest', [SaldoBankController::class, 'getLatest']);
