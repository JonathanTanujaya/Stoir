...
class UpdatePenerimaanFinanceDetailRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'jumlah_bayar' => 'sometimes|required|numeric|min:0|max:99999999999999.99',
            'jumlah_dispensasi' => 'sometimes|required|numeric|min:0|max:99999999999999.99',
