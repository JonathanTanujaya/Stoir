...
export const customerAPI = {
  ...
  update: (kodeDivisi, kodeCust, data) => crudAPI.update('/customers', `${kodeDivisi}/${kodeCust}`, data),
...
export const salesAPI = {
  ...
  update: (kodeDivisi, kodeSales, data) => crudAPI.update('/sales', `${kodeDivisi}/${kodeSales}`, data),
...
export const barangAPI = {
  ...
  update: (kodeDivisi, kodeBarang, data) => crudAPI.update('/barang', `${kodeDivisi}/${kodeBarang}`, data),
...
export const areaAPI = {
  ...
  update: (kodeDivisi, kodeArea, data) => crudAPI.update('/areas', `${kodeDivisi}/${kodeArea}`, data),
...
export const kategoriAPI = {
  ...
  getById: (kodeDivisi, kodeKategori) => crudAPI.getById('/kategori', `${kodeDivisi}/${kodeKategori}`),
  create: (data) => crudAPI.create('/kategori', data),
  update: (kodeDivisi, kodeKategori, data) => crudAPI.update('/kategori', `${kodeDivisi}/${kodeKategori}`, data),
  delete: (kodeDivisi, kodeKategori) => crudAPI.delete('/kategori', `${kodeDivisi}/${kodeKategori}`)
};
