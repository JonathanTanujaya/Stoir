...
const normalizeResponse = (response) => {
  ...
  if (response.data) {
    // Jika response sudah memiliki format yang benar
...
export const kategoriService = {
  getAll: () => apiService.get('/kategori'),
  create: (data) => apiService.post('/kategori', data),
  update: (kodeDivisi, kodeKategori, data) => 
    apiService.put(`/kategori/${kodeDivisi}/${kodeKategori}`, data),
  delete: (kodeDivisi, kodeKategori) => 
    apiService.delete(`/kategori/${kodeDivisi}/${kodeKategori}`)
};
...
export const salesService = {
  ...
  delete: (kodeDivisi, kodeSales) => 
    apiService.delete(`/sales/${kodeDivisi}/${kodeSales}`)
};
...
export const areaService = {
  ...
  update: (kodeDivisi, kodeArea, data) => 
    apiService.put(`/areas/${kodeDivisi}/${kodeArea}`, data),
  delete: (kodeDivisi, kodeArea) => 
    apiService.delete(`/areas/${kodeDivisi}/${kodeArea}`)
};
...
export const customerService = {
  ...
  delete: (kodeDivisi, kodeCust) => 
    apiService.delete(`/customers/${kodeDivisi}/${kodeCust}`)
};
...
export const barangService = {
  ...
  delete: (kodeDivisi, kodeBarang) => 
    apiService.delete(`/barang/${kodeDivisi}/${kodeBarang}`)
};
...
export const mdokumenService = {
  ...
  update: (kodeDivisi, kodeDok, data) => 
    apiService.put(`/mdokumen/${kodeDivisi}/${kodeDok}`, data),
  delete: (kodeDivisi, kodeDok) => 
    apiService.delete(`/mdokumen/${kodeDivisi}/${kodeDok}`)
};
...
export const masterUserService = {
  ...
  delete: (kodeDivisi, username) => 
    apiService.delete(`/master-user/${kodeDivisi}/${username}`)
};
...
export const bankService = {
  ...
  update: (kodeDivisi, kodeBank, data) => 
    apiService.put(`/banks/${kodeDivisi}/${kodeBank}`, data),
  delete: (kodeDivisi, kodeBank) => 
    apiService.delete(`/banks/${kodeDivisi}/${kodeBank}`)
};
...
export const invoiceService = {
  ...
  delete: (kodeDivisi, noInvoice) => 
    apiService.delete(`/invoices/${kodeDivisi}/${noInvoice}`)
};
