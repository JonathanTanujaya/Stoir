...
export const ShowOn = ({ breakpoint, children }) => {
  ...
  const shouldShow = useMediaQuery(
    breakpoint === 'mobile' ? theme.breakpoints.down('md') :
    breakpoint === 'tablet' ? theme.breakpoints.between('md', 'lg') :
    breakpoint === 'desktop' ? theme.breakpoints.up('lg') :
    breakpoint === 'small' ? theme.breakpoints.down('sm') :
