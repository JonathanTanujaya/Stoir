...
import { faPlus, faEdit, faTrash, faEye, faSearch, faCalendarAlt, faPiggyBank } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className="p-6">
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold text-gray-800">Penambahan Saldo</h1>
        </div>
        <p className="text-gray-600">Kelola data penambahan saldo dan modal</p>
      </div>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredData.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{item.jenisTransaksi}</td>
