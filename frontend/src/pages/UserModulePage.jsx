...
import UserModuleList from '../components/UserModuleList';
import UserModuleForm from '../components/UserModuleForm';
...
function UserModulePage() {
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h1>Manajemen User Module</h1>
      {view === 'list' ? (
        <>
          <button onClick={handleNew} style={{ marginBottom: '10px' }}>
            Tambah Baru
          </button>
          <UserModuleList onEdit={handleEdit} onRefresh={refreshKey} />
        </>
      ) : (
        <>
