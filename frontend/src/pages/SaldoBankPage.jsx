...
import SaldoBankList from '../components/SaldoBankList';
import SaldoBankForm from '../components/SaldoBankForm';
    ...
    <div style={{ padding: '20px' }}>
      {view === 'list' ? (
        <>
          ...
          <SaldoBankList onEdit={handleEdit} onRefresh={refreshKey} />
        </>
      ) : (
        <>
