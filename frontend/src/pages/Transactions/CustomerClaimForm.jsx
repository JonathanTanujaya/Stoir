    ...
    <div className="page-container">
      ...
      <form onSubmit={handleSubmit}>
                ...
                >
                  ...
                  {invoices.map((invoice) => (
                    <option key={invoice.id} value={invoice.id}>
                      {invoice.no_invoice} - {new Date(invoice.tanggal).toLocaleDateString('id-ID')} (Rp {invoice.total.toLocaleString()})
                    </option>
                  ))}
                </select>
              </div>
        ...
        <div className="card">
          ...
          <div className="card-body">
            {items.length === 0 ? (
              <p className="text-muted">Belum ada item claim. Klik "Tambah Item" untuk menambahkan.</p>
            ) : (
