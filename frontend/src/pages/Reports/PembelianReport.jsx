...
const PembelianReport = () => {
  ...
  if (loading) {
    return <div className="page-container"><div className="loading-spinner">Loading...</div></div>;
  }
        ...
        <div className="card-body">
          <div className="form-grid grid-cols-3">
            <div className="form-group">
              ...
              <select name="supplier" value={filters.supplier} onChange={handleFilterChange} className="form-control">
          ...
          <div className="form-actions">
            <button className="btn btn-primary" onClick={fetchPembelian}>Apply Filter</button>
            <button className="btn btn-secondary" onClick={() => setFilters({ supplier: '', dateFrom: '', dateTo: '' })}>Reset</button>
          </div>
        </div>
      </div>
